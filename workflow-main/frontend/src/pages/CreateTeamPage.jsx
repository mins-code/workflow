...
const CreateTeamPage = () => {
  ...
  if (step === 1) {
    return (
      <div className="p-6">
        <h1 className="text-2xl font-bold text-gray-800 mb-4">Create New Team</h1>
  ...
  return (
    <div className="p-6">
      <h1 className="text-2xl font-bold text-gray-800 mb-4">Onboard Members to Team</h1>
      {error && <p className="text-red-500">{error}</p>}
      ...
      <h2 className="text-xl font-bold text-gray-800 mt-6">Onboarded Members</h2>
